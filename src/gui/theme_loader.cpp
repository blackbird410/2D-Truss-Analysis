...
bool ThemeLoader::applyTheme(QApplication& app, const QString& resourcePath) {
    ...
    const bool isDark = resourcePath.contains(QLatin1String("dark"), Qt::CaseInsensitive);
...
QString ThemeLoader::savedThemePath() {
    QSettings settings(QString::fromLatin1(kSettingsOrg), QString::fromLatin1(kSettingsApp));
    return settings.value(QString::fromLatin1(kSettingsKey), QString::fromLatin1(kDarkThemePath))
        .toString();
}
