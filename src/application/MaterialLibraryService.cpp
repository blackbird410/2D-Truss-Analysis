...
std::optional<MaterialProperties> MaterialLibraryService::getMaterial(const std::string& name) const {
...
void MaterialLibraryService::initializeDefaultMaterials() {
    ...
    // Concrete (C25/30 - Common structural concrete)
    {
        ...
        addCustomMaterial("Concrete",
                         "Structural concrete C25/30",
                         props);
    }
    ...
    // Timber (Softwood - Spruce/Pine/Fir)
    {
        ...
        addCustomMaterial("Timber",
                         "Softwood (Spruce/Pine/Fir)",
                         props);
    }
}
...
void MaterialLibraryService::initializeDefaultSections() {
    // Circular sections (solid)
    {
        ...
        addCustomSection("Circular 50mm",
                        "Solid circular section (diameter 50mm)",
                        props);
    }
    
    {
        ...
        addCustomSection("Circular 100mm",
                        "Solid circular section (diameter 100mm)",
                        props);
    }
    ...
    // Square sections (solid)
    {
        ...
        addCustomSection("Square 50mm",
                        "Solid square section (50mm × 50mm)",
                        props);
    }
    
    {
        ...
        addCustomSection("Square 100mm",
                        "Solid square section (100mm × 100mm)",
                        props);
    }
    ...
    // Rectangular sections (solid)
    {
        ...
        addCustomSection("Rectangular 30x50mm",
                        "Solid rectangular section (30mm × 50mm)",
                        props);
    }
    
    {
        ...
        addCustomSection("Rectangular 60x100mm",
                        "Solid rectangular section (60mm × 100mm)",
                        props);
    }
}
