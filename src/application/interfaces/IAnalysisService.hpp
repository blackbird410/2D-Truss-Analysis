...
public:
     ...
     */
    virtual Result<ResultsHandle> analyze(
     ...
     */
    virtual const core::interfaces::IAnalysisResultsView& getResultsView(
        ResultsHandle handle) const = 0;
     ...
     */
    virtual Result<bool> exportResults(
        ResultsHandle handle,
        infrastructure::export_::ExportFormat format,
        const std::filesystem::path& filepath,
        const core::Truss& truss,
        const infrastructure::export_::ExportOptions& options = infrastructure::export_::ExportOptions{}) = 0;
