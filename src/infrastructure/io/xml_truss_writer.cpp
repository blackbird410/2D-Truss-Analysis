...
bool XmlTrussWriter::write(const core::interfaces::TrussDTO& trussData,
...
void XmlTrussWriter::createMetadata(tinyxml2::XMLDocument& doc,
...
void XmlTrussWriter::createNodes(tinyxml2::XMLDocument& doc,
                                 tinyxml2::XMLElement* root,
                                 const core::interfaces::TrussDTO& trussData) {
...
void XmlTrussWriter::createMembers(tinyxml2::XMLDocument& doc,
                                   tinyxml2::XMLElement* root,
                                   const core::interfaces::TrussDTO& trussData) {
...
void XmlTrussWriter::createLoads(tinyxml2::XMLDocument& doc,
                                 tinyxml2::XMLElement* root,
                                 const core::interfaces::TrussDTO& trussData) {
