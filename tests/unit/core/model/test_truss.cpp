...
TEST(TrussTest, GetConstrainedNodes) {
    ...
    EXPECT_TRUE(std::find(constrainedNodes.begin(), constrainedNodes.end(), node1) !=
                constrainedNodes.end());
    EXPECT_TRUE(std::find(constrainedNodes.begin(), constrainedNodes.end(), node2) !=
                constrainedNodes.end());
    EXPECT_TRUE(std::find(constrainedNodes.begin(), constrainedNodes.end(), node4) !=
                constrainedNodes.end());

    // Verify free nodes are not in the list
    EXPECT_TRUE(std::find(constrainedNodes.begin(), constrainedNodes.end(), node3) ==
                constrainedNodes.end());
    EXPECT_TRUE(std::find(constrainedNodes.begin(), constrainedNodes.end(), node5) ==
                constrainedNodes.end());
}
