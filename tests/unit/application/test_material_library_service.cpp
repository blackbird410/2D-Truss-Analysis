...
TEST_F(MaterialLibraryServiceTest, GetAvailableMaterials_IncludesAllDefaults) {
    ...
    EXPECT_TRUE(std::find(materialNames.begin(), materialNames.end(), "Steel") != materialNames.end());
    EXPECT_TRUE(std::find(materialNames.begin(), materialNames.end(), "Aluminum") != materialNames.end());
    EXPECT_TRUE(std::find(materialNames.begin(), materialNames.end(), "Concrete") != materialNames.end());
    EXPECT_TRUE(std::find(materialNames.begin(), materialNames.end(), "Timber") != materialNames.end());
}
...
TEST_F(MaterialLibraryServiceTest, GetAvailableSections_IncludesAllDefaults) {
    ...
    EXPECT_TRUE(std::find(sectionNames.begin(), sectionNames.end(), "Circular 50mm") != sectionNames.end());
    EXPECT_TRUE(std::find(sectionNames.begin(), sectionNames.end(), "Circular 100mm") != sectionNames.end());
    EXPECT_TRUE(std::find(sectionNames.begin(), sectionNames.end(), "Square 50mm") != sectionNames.end());
    EXPECT_TRUE(std::find(sectionNames.begin(), sectionNames.end(), "Square 100mm") != sectionNames.end());
    EXPECT_TRUE(std::find(sectionNames.begin(), sectionNames.end(), "Rectangular 30x50mm") != sectionNames.end());
    EXPECT_TRUE(std::find(sectionNames.begin(), sectionNames.end(), "Rectangular 60x100mm") != sectionNames.end());
}
