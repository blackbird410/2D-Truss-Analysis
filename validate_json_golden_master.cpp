/**
 * @file validate_json_golden_master.cpp
 * @brief Validate JSONExporter output against golden master
...
/**
 * @brief Compare two JSON files, ignoring timestamp differences
 */
bool compareJSONFiles(const std::string& file1, const std::string& file2) {
...
int main() {
    std::cout << "Golden Master JSON Validation" << std::endl;
    ...
    // Step 3: Export with JSONExporter
    std::cout << "Step 3: Exporting with JSONExporter..." << std::endl;
    ...
    std::string outputPath = "test_golden_validation.json";
    ...
    bool identical = compareJSONFiles(goldenPath, outputPath);
